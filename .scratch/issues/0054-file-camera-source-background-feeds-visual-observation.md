...
- [x] File Camera Source lanes can access background state needed for foreground extraction.
- [x] File-based visual observation uses background-diff behavior during Vision Pipeline runtime.
- [x] Existing file Camera Source feed ownership and loop behavior remain intact.
- [x] Tests prove file Camera Source motion relative to background emits Moving Object Observations.
