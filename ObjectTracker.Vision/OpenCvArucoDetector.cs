...
public sealed class OpenCvArucoDetector : ICachedDetectionAlgorithm
{
    ...
    {
        // decodedImage is expected to be Grayscale Mat
        cancellationToken.ThrowIfCancellationRequested();
        ...
        Cv2.AdaptiveThreshold(decodedImage, threshold, 255, AdaptiveThresholdTypes.GaussianC, ThresholdTypes.BinaryInv, 15, 5);
